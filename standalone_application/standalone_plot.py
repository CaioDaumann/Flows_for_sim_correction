...
def plott(data_hist,mc_hist,mc_rw_hist ,output_filename,xlabel, zmmg = None  ):
    ...
    if( zmmg ):
        ...
        hep.histplot(
            mc_hist,
            label = r'$Z\rightarrow \mu\mu\gamma$',
            density = True,
            color = "blue",
            linewidth=3,
            ax=ax[0]
        ...
        hep.histplot(
            mc_rw_hist,
            label = r'$Z\rightarrow  \mu\mu\gamma$ Corr',
            density = True,
            color = "red",
            linewidth=3,
            ax=ax[0]
    ...
    ax[0].set_xlabel('')
    ax[0].margins(y=0.15)
    ax[0].set_ylim(0, 1.10*ax[0].get_ylim()[1])
...
def plot_mvaID_curve(mc_inputs,data_inputs,nl_inputs, mc_conditions, data_conditions,mc_weights, data_weights, plot_path, zmmg = False):
    ...
    if( zmmg ):
        plott( data_mva , mc_mva, nl_mva , plot_path + '/mvaID_barrel.png', xlabel = "Barrel mvaID" , zmmg = True )
    else:
